...
Cenario: variacao (b) do cenario base (simular_duogoal.py) — taxa em queda
de 12,00% a.a. (em vez da SELIC 14,25% a.a.). Demais parametros iguais:
Apartamento R$ 450 mil, Reserva R$ 45 mil, aporte R$ 7.000, base 02/08/2026.

Uso: $env:PYTHONPATH = "<raiz do projeto>"; python simulacoes/simular_selic_12.py
"""
