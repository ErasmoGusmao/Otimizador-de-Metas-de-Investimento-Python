...
Cenario: capitais iniciais atualizados para 04/08/2026 — Apartamento com
R$ 230.074,07 ja aplicados (alvo R$ 450 mil) e Reserva de emergencia com
R$ 34.505,87 ja aplicados (alvo R$ 45 mil). SELIC 14,25% a.a., aporte
mensal total R$ 8.000, sem aporte extra, base 04/08/2026.

Uso: $env:PYTHONPATH = "<raiz do projeto>"; python simulacoes/simular_capital_atual.py
...
inputs = SolverInputs(
    taxa_tipo="anual",
    taxa_valor=0.1425,
    capital_meta1=230_074.07,
    capital_meta2=34_505.87,
