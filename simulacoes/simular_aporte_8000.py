...
Cenario: variacao (a) do cenario base (simular_duogoal.py) — aporte mensal
total de R$ 8.000 (em vez de R$ 7.000). Demais parametros iguais:
Apartamento R$ 450 mil, Reserva R$ 45 mil, SELIC 14,25% a.a., base 02/08/2026.

Uso: $env:PYTHONPATH = "<raiz do projeto>"; python simulacoes/simular_aporte_8000.py
"""
