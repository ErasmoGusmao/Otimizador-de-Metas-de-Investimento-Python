...
Cenario: variacao (c) do cenario base (simular_duogoal.py) — Reserva de
emergencia mais robusta, alvo R$ 60.000 (em vez de R$ 45.000). Demais
parametros iguais: Apartamento R$ 450 mil, SELIC 14,25% a.a., aporte
R$ 7.000, base 02/08/2026.

Uso: $env:PYTHONPATH = "<raiz do projeto>"; python simulacoes/simular_reserva_60000.py
"""
