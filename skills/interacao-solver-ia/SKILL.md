...
## Fase 3 - Execucao
Script ad-hoc em `TEMP/opencode/`, com `PYTHONPATH` apontando para o diretorio do projeto, chamando `resolver_duas_metas(SolverInputs(...))`. Nao modificar codigo do projeto.
